...
onready var green = get_node("Button4/Area2D/Button/TextureButton")
onready var blue = get_node("Button2/Area2D/Button/TextureButton")
onready var red = get_node("Button/Area2D/Button/TextureButton")
onready var yellow = get_node("Button3/Area2D/Button/TextureButton")
